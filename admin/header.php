            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li >
                        <a  href="freelancers.php"><i class="fa fa-user fa-2x"></i>Manage Freelancers</a>
                    </li>
                    <li >
                        <a  href="clientsappointments.php"><i class="fa fa-calendar fa-2x"></i>Manage Clients Appointments</a>
                    </li>
                    <li >
                        <a  href="clients.php"><i class="fa fa-users fa-2x"></i>Manage Clients Details</a>
                    </li>
                    <li >
                        <a  href="pricing.php"><i class="fa fa-money fa-2x"></i>Manage Pricing</a>
                    </li>
                  <li  >
